    ...
    <div className="w-screen h-dvh overflow-hidden relative">
      ...
      <div className="absolute inset-0 z-20 overflow-visible">
        <img
          ...
          className="absolute inset-0 w-full h-full object-cover   max-sm:hidden "
        />
        <img
      ...
      <div className="sm:hidden absolute bottom-12 right-0 z-30 flex flex-col items-end p-4 space-y-0">
        <a
