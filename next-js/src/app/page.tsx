  ...
  return (<div className=''>
    <div className='w-full z-0 flex static'>
      ...
      <div className=''>
        ...
        <div className='font-title m-10 absolute top-0 right-0 text-white z-40 text-8xl'>
          <Link href="/blog">
            <img
              className="h-16 md:h-28 min-w-10"
        ...
        <div className='font-title m-10 absolute right-0 text-white z-40 my-80 pt-28 text-8xl'>
          <Link href="/events">
            <img
