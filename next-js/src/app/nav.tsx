    ...
    <main >
      <div> {/*nav bar?*/}
        ...
        <div className="w-full h-24 py-5 justify-between items-start inline-flex static">
          ...
          <div className="grow basis-5/6 h-12 justify-between items-center flex">
          ...
          <div className="pl-10">
            <div className="h-14 px-4 bg-gradient-to-r from-[#aa3e98] to-[#9368b7] rounded-3xl shadow justify-between items-center inline-flex">
              ...
              <div className="text-center text-white font-semibold leading-3 tracking-wide font-bit">SONG OF THE DAY</div>
            </div>
          </div>
        </div>
      </div>
