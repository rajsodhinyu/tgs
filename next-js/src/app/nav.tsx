    ...
    <main >
        <div className="w-full h-24 py-5 items-start inline-flex static"> {/*whole nav bar*/}
          <div className="grow h-12 items-center flex pr-8 gap-x-8"> {/*everything not inc SOTD?*/}
            ...
            <Link href="/blog">
              <img className="h-12 min-w-24" src="https://cdn.sanity.io/images/fnvy29id/tgs/9a5244d1c770d1e667006b7f54f5738745847917-1533x846.png" />
            </Link>
            <Link href="/events">
              <img className="h-12 min-w-32" src="https://cdn.sanity.io/images/fnvy29id/tgs/a82c27d8c7dcd43014eaa1fdc852185942645f7e-2037x795.png" />
            </Link>
            <Link href="/">
              <img className="w-24 h-12 min-w-24" src="https://cdn.sanity.io/images/fnvy29id/tgs/7162c809beb7a870dfbb0127b72fc6359218b456-1874x954.png" />
            </Link>
            </div>
          <div className="place-content-end"> {/*SOTD widget*/}
            <div className="h-14 px-4 bg-gradient-to-r from-[#aa3e98] to-[#9368b7] rounded-3xl shadow justify-between items-center inline-flex">
              ...
              <div className="text-center bg-white bg-clip-text text-white whitespace-nowrap font-extrabold lg:text-2xl sm:text-sm leading-3 tracking-wide font-title">SONG OF THE DAY</div>
            </div>
          </div>
        </div>
    </main>
