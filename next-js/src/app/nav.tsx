...
export default function Nav() {
  return (
    <main >
        <div className="w-svh m-10 mx-3 md:mt-4 inset-0 h-24 flex items-baseline md:items-center flex-wrap md:justify-between  md:flex-nowrap md:flex-row justify-around"> {/*whole nav bar*/}
          <div className="shrink h-12 flex gap-6 items-end lg:gap-8 justify-start"> {/*everything not inc SOTD?*/}
            <Link href='/'>
            ...
            <div className=""> 
              <div className="w-72 xl:w-72 mt-4 md:ml-4 xl:flex-none h-16 bg-gradient-to-r from-[#aa3e98] to-[#9368b7] rounded-xl inline-flex place-items-center align-center justify-around">
                <div>
