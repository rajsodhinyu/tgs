    ...
    <main >
        <div className="w-full h-24 py-5 items-start inline-flex static"> {/*whole nav bar*/}
          ...
          <div className="place-content-end"> {/*SOTD widget*/}
            <div className="h-14 px-4 bg-gradient-to-r from-[#aa3e98] to-[#9368b7] rounded-2xl shadow justify-between items-center inline-flex">
              <div className="h-11 pr-9 relative">
