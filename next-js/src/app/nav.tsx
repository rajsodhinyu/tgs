    ...
    <main >
        ...
        md:justify-between md:flex-nowrap md:flex-row"> {/*whole nav bar*/}
          <div className="shrink h-12 flex px-6 gap-4 lg:gap-8 items-center md:justify-start"> {/*everything not inc SOTD?*/}
            ...
            <div className="">
              <div className=" w-72 md:w-64 lg:w-80 xl:flex-none h-14 mt-2 bg-gradient-to-r from-[#aa3e98] to-[#9368b7] rounded-2xl shadow inline-flex place-items-center justify-around">
                <div className="">
