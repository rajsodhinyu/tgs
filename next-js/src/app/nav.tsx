...
export default function Nav() {
  return (
    <main >
        <div className="w-svh sm:m-10 mx-3 md:mt-4 inset-0 h-24 flex items-baseline md:items-center flex-wrap md:justify-between  md:flex-nowrap md:flex-row justify-around"> {/*whole nav bar*/}
