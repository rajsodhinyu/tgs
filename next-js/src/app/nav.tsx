    ...
    return (
      <main>
        ...
        <div className="flex items-center px-9 pt-6">
          <div className="flex-auto"> <Image src="https://cdn.sanity.io/images/fnvy29id/tgs/6e0d6fefaf95cf0e570f958d10c13cf66265735a-1266x750.png" alt="TGS Logo" width={120} height={70} priority /></div>
