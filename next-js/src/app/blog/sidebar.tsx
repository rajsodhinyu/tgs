...
export default async function Sidebar({ items}: { items: number}) {
  ...
  return (
    <div className="">
      <div className=" font-bold hover:underline hover:text-tgs-purple decoration-tgs-purple text-black flex shrink text-3xl  font-bit leading-10 text-balance w-full justify-center">
