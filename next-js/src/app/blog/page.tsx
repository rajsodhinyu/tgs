...
export default function Page() {
  return (
  <div className="flex-wrap gap-2.5 md:-mt-4 ml-4 lg:-mr-4 md:flex-nowrap md:inline-flex md:flex-row md:justify-around w-auto xl:w-screen
  pt-12"> 
  {/* Whole Site */}
    ...
    <div className="sm:w-screen md:w-9/12 lg:w-6/12 flex-col place-items-center justify-end ">
      <div className="tracking-wide font-bold hover:underline decoration-purple-700 text-black text-3xl md:-mt-3 lg:text-4xl  font-bit leading-10 text-center"><a href="/blog/archive">All Posts</a></div>
