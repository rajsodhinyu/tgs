...
export default function Page() {
    return (<div className="bg-gradient-to-r sm:px-40 px-20 h-svh w-full flex flex-col justify-around">
        <div className="flex sm:text-2xl text-lg font-black font-bit text-pretty text-center sm:text-balance">
