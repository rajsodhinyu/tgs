...
export default function Page() {
    return (<div className="mt-20 sm:px-40 mx-8">
        <div className="md:text-lg text-sm font-black font-bit text-pretty text-center sm:text-balance">
            <p> That Good Sh*t! because good music transcends genre.

Our mission is to build community around shared love of music. With authenticity at the core of everything we do, TGS is your go-to source for keeping up with the most impactful and innovative music of today!
